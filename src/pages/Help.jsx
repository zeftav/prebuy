...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Yes. On the Logbook audit, each notable event and each part/component has an “on report” toggle (the little document icon). Events show on the report by default — tap to hold one back until you’ve verified it. Parts/components are opt-in: tap to include one, and it’s added to a “Components & parts” section on the report. Timed items (compliance) have an “On report” checkbox on the Timed-items tool. Equipment has an “On report” checkbox on each item in the Aircraft Profile (with All / None toggles per group) — untick anything you don’t want shown, like inop items, personal gear, or duplicates, and it stays in your working profile but drops off the report. Since publishing freezes a revision, you can hold an item back, finish it, then publish the next revision to include it.',
  },
  {
